...
//            buttons: [.previous, .goToControls, .showInterest]),
        .soundAnalyserOnlyIntro: .init(
            title: "all ears",
            body: """
            Let the Apple Vision Pro listen to the world around you, and don't miss the things that are happening around you.
            
            Use the sensitivity slider, and let the critter tell you when there are sounds around you.
            """,
            buttons: [.standard, .micPermissions]),
        .controls: .init(
            title: "",
